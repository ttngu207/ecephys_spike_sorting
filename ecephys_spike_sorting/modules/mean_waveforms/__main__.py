...
def calculate_mean_waveforms(args):
    ...
    if args['mean_waveform_params']['use_C_Waves']:
        ...
        cmd_parts.append(' -clus_table_npy='+clus_table_npy)
        cmd_parts.append(' -clus_time_npy='+clus_time_npy)
        cmd_parts.append(' -clus_lbl_npy='+clus_lbl_npy)
        cmd_parts.append(' -dest='+dest)
        ...
        site_x = channel_pos[:, 0]
        site_y = channel_pos[:, 1]
